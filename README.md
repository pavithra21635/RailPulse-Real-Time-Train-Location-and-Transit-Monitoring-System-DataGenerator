...
Start Authentication Server - node authentication.js

Trigger Data Generation

 * Visit http://localhost:8080/start to start generating train data

 * Visit http://localhost:8080/stop to stop data generation
